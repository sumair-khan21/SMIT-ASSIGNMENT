...
const Registration = () => {
  ...
  return (
   ...
   >
    ...
    <input type="text"  name='fullname' placeholder='Your full name' value={inputs.fullname} onChange={handleChange}
    ...
    <input type="email"  name='email' placeholder='Your email' value={inputs.email} onChange={handleChange}
    ...
    <input type="number"  name='cnic' placeholder='Your cnic' value={inputs.cnic} onChange={handleChange}
    ...
    <input type="password"  name='password' placeholder='Your password' value={inputs.password} onChange={handleChange}
    ...
    <label className="block text-sm font-medium text-gray-700 mb-1">Choose Car</label>
    ...
    <label className="flex items-center gap-2 mb-3 cursor-pointer">
      <input type="checkbox" name="newsletter" checked={inputs.newsletter} onChange={handleChange}
    ...
    <label className="flex items-center gap-2 mb-4 cursor-pointer">
      <input type="checkbox" name="terms" checked={inputs.terms} onChange={handleChange}
    ...
    <textarea name="details" value={inputs.details} onChange={handleChange}
    ...
    <button type='submit'
      className="w-full py-3 px-6 font-semibold rounded-lg bg-gradient-to-r from-blue-500 to-purple-600 text-white border border-transparent shadow-md hover:shadow-xl hover:scale-[1.02] active:scale-95 transition-transform duration-300 cursor-pointer"
    >
      Submit
    </button>
   </form>
