...
import { X, DollarSign, Package, Tag, Star, Image as ImageIcon } from 'lucide-react';
...
const EditProductModal = ({ isOpen, onClose, onSuccess, product }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const result = await productOperations.update(product.id, productData);
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-white/80 text-sm">ID: {product.id}</p>
              </div>
            </div>
            <button
              onClick={handleClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 max-h-[calc(100vh-200px)] overflow-y-auto">
            ...
            <div className="md:col-span-2">
              ...
              {formData.image_url && (
                <img
                  ...
                  alt="Preview"
                  className="mt-2 h-24 w-24 object-cover rounded-lg border-2 border-purple-200"
          ...
          <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4 mt-8 pt-6 border-t border-gray-200">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex-1 px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-xl hover:shadow-xl transform hover:scale-105 transition-all duration-200 disabled:opacity-50"
            >
